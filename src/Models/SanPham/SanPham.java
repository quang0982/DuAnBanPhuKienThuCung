...
public class SanPham {
    ...
    public SanPham(String maSp, String tenSp, String maCC, String anh, String anhQr, String loai, String ChatLieu, int Solg, float donGia, String moTa, int maAnh, int IdNcc, int idLoai, int idChatLieu) {
        this.maSp = maSp;
        this.tenSp = tenSp;
        this.maCC = maCC;
        this.anh = anh;
