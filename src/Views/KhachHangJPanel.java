        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnMoi, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
...
//        tabs.setSelectedIndex(1);
        ...
        try {
            ...
            String sql = "select TenKhachHang,TenSanPham,SDT,KHACHHANG_LICHSUMUAHANG.soLuong,KHACHHANG_LICHSUMUAHANG.SoLuong*SanPham.DonGia as 'tongTien',ThanhToan\n" +
...
"	where IDKhachHang = '" + txtMaKhachHang.getText() + "'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int so = JOptionPane.showConfirmDialog(this, "Bạn có muốn xóa không");
        if(so == 0){
            dao.delete(txtMaKhachHang.getText());
